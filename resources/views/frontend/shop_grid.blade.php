                            ...
                            <div class="col-lg-4 col-md-5">
                                <div class="filter__sort">
                                    ...
                                    <select name="sort" id="sort">
                                        <option {{ request()->query('sort') == 0 ? 'selected' : '' }} value="0">New</option>
                                        <option {{ request()->query('sort') == 1 ? 'selected' : '' }} value="1">Low To High</option>
                                        <option {{ request()->query('sort') == 2 ? 'selected' : '' }} value="2">High To Low</option>
